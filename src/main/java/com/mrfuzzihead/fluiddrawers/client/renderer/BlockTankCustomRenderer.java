...
public class BlockTankCustomRenderer extends BlockTankRenderer {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer) {
        ...
        renderInventoryShape(tank, tank.getDefaultTexture(), tank.getDefaultTexture(), renderer, true);
    }
     ...
     * {@code sideIcon} and the trim border with {@code trimIcon}.
     */
    public void renderInventoryShape(BlockTankCustom tank, IIcon sideIcon, IIcon trimIcon, RenderBlocks renderer,
        boolean fullBright) {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (pass == 0) {
            ...
            renderGlass(tank, tank.getIconGlass(), renderer, x, y, z);
